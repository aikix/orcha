...
- **Cross-repo patterns** (e.g., "3 repos bumped trust-mcp this week")
...
> "trust-data-service has 3 merged PRs not covered by KB docs. Run /orcha-kb-update trust-data-service?"
